    ...
    <div class="min-h-screen bg-gray-50 flex">
        ...
        >
            ...
            <div class="p-4 border-t border-primary-dark">
                <button class="flex items-center w-full p-3 rounded-lg hover:bg-red-600 transition-colors text-white">
            ...
            <header class="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-6 shrink-0">
                ...
                <div class="flex items-center space-x-4">
                    <div class="text-right hidden sm:block">
                        ...
                        <p class="text-xs text-gray-500">admin@kampungbungas.id</p>
                    </div>
                    <div class="w-10 h-10 rounded-full bg-primary-extralight flex items-center justify-center text-primary font-bold">
                        A
                    </div>
                </div>
            </header>
