    ...
    <Teleport to="body">
        ...
        >
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div 
                    @click="close"
                    class="fixed inset-0 bg-slate-900/75 backdrop-blur-sm transition-opacity z-0" 
                    aria-hidden="true"
                ></div>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            >
                                ...
                                <svg v-else class="h-6 w-6 text-emerald-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
