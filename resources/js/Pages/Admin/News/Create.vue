...
const form = useForm({
    ...
    thumbnail: null,
    pdf_file: null,
    published_at: getCurrentDateTimeString(),
});
        ...
        <template #header>
            <div class="flex justify-between items-center bg-white/40 backdrop-blur-xs py-4 px-6 rounded-2xl border border-gray-100/50 shadow-xs -mx-4">
                <div class="flex flex-col gap-1">
                    <h2 class="font-extrabold text-xl text-gray-900 tracking-tight leading-tight">Tambah Berita</h2>
                    <p class="text-xs text-gray-400">Tulis dan terbitkan artikel baru untuk informasi warga.</p>
                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                            ...
                            <div class="space-y-4">
                                ...
                                <!-- Tanggal Publikasi -->
                                <div>
                                    <label for="published_at" class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Tanggal Publikasi (Opsional)</label>
                                    <div class="relative">
                                        <input
                        ...
                        <!-- PDF Attachment -->
                        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                            <h3 class="text-sm font-bold text-gray-900 mb-4 border-b border-gray-50 pb-2">Lampiran PDF (Opsional)</h3>
                            <FileUpload
                            ...
                            />
                            <p class="mt-3 text-xs text-gray-400 italic font-medium leading-relaxed">Gunakan ini untuk berita seperti majalah, warta desa, atau dokumen resmi.</p>
                        </div>
                    </div>
                </form>
            </div>
